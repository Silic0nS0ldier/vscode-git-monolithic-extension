...
import { API, GitExtension, Repository, Status } from "extension/dist/api/git.js";
import { eventToPromise } from "extension/dist/util.js";
import "mocha";
import * as assert from "node:assert";
import * as cp from "node:child_process";
import * as fs from "node:fs";
import * as path from "node:path";
import { commands, extensions, Range, TextDocument, Uri, window, workspace, WorkspaceEdit } from "vscode";
