...
import { EndOfLine, OutputChannel, Uri, window } from "vscode";
import vsDiff from "vscode-diff";
import { prettyPrint } from "../../../logging/pretty-print.js";
import { applyLineChanges, intersectDiffWithRange, toLineRanges } from "../../../staging.js";
...
export function createCommand(model: Model, outputChannel: OutputChannel): ScmCommand {
    async function stageSelectedRanges(fileUri: unknown, ...rest: unknown[]): Promise<void> {
