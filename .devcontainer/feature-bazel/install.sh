...
if [[ $ARCH == "arm64" ]] || [[ $ARCH == "aarch64" ]]; then
    ...
    curl https://github.com/pnpm/pnpm/releases/download/v10.12.4/pnpm-linux-arm64 -Lo /usr/local/bin/pnpm
    ...
    curl https://github.com/pnpm/pnpm/releases/download/v10.12.4/pnpm-linux-x64 -Lo /usr/local/bin/pnpm
else
